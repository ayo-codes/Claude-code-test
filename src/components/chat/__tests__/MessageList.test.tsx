...
test("MessageList renders messages with parts", () => {
  const messages: Message[] = [
    {
      ...
      parts: [
        { type: "text", text: "Creating your component..." },
        {
          ...
          toolInvocation: {
            toolCallId: "asdf",
            // Include a realistic command + path so ToolCallBadge can render
            // a friendly label instead of the raw tool name
  ...
  // ToolCallBadge now shows a friendly label instead of the raw tool name
